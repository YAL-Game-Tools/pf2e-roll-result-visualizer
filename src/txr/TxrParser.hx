				...
				default: {
					if (c == "d".code) { // d6 etc
						...
						if (c >= "0".code && c <= "9".code) {
							...
							out.push(Die(d, Std.parseInt(s.substring(start + 1, pos))));
						} else {
							throw "Expected a die size after `d` at position " + start;
						}
